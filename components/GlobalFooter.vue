<template>
  <footer class="text-center flex flex-col items-center">
    <div class="icon-container">
      <a href="https://twitter.com/eStivaros" class="footer-icon">
        <svg
      ...
      <a href="https://blog.stivaros.com" class="footer-icon">
        <svg
          class="h-8 w-8 text-green-900"
          viewBox="0 0 24 24"
          fill="none"
      ...
      <a href="https://www.linkedin.com/in/estivaros/" class="footer-icon">
        <svg
          class="h-8 w-8 text-green-900"
          viewBox="0 0 24 24"
          fill="none"
      ...
      <a href="https://github.com/stivaros" class="footer-icon">
        <svg
          class="h-8 w-8 text-green-900"
          viewBox="0 0 24 24"
          fill="none"
      ...
      <a href="https://ntscreative.co.uk" class="footer-icon">
        <svg
          class="h-8 w-8 text-green-900"
          viewBox="0 0 24 24"
          fill="none"
    ...
    <p class="mb-4">&copy; Efstathios Stivaros 2021</p>
  </footer>
</template>
